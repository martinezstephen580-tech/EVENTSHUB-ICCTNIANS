...
class AdminPanel {
    ...
    async init() {
        ...
        if (!this.isAdmin) {
            ...
            // Redirect or hide admin elements
    ...
    disableAdminFunctions() {
        ...
        containers.forEach(container => {
            if (container) {
                container.innerHTML = '<div class="alert alert-danger"><i class="fas fa-lock"></i> Admin access required</div>';
            }
        });
    }
    ...
    if (adminLink) {
        adminLink.addEventListener('click', function(e) {
            ...
            if (!isAdmin) {
                ...
                // Show admin login modal if exists
            ...
            if (adminPanel) {
                ...
                alert("Admin panel not found on this page.");
            }
        });
    }
